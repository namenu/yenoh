...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_40761 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_40761(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_40762 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_40762(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_40763 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_40763(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_40764 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_40764(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_40766 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_40766(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_40774 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_40774(reader);
}
});
...
var G__40881 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__40882 = s.append(c);
c = G__40881;
s = G__40882;
continue;
}
