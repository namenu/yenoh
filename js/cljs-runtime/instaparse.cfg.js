...
var G__53018 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__53018)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__53018)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__53018)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__53018)].join('')));
...
var G__53368 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__53369 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__53368;
v = G__53369;
continue;
} else {
var G__53371 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__53372 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__53371;
v = G__53372;
continue;
}
...
break;
case "\"":
var G__53378 = cljs.core.next(sq);
var G__53379 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__53378;
v = G__53379;
continue;
...
break;
default:
var G__53384 = cljs.core.next(sq);
var G__53385 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__53384;
v = G__53385;
continue;
...
while(true){
var G__53198 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__53198__$1 = (((G__53198 instanceof cljs.core.Keyword))?G__53198.fqn:null);
switch (G__53198__$1) {
case "rule":
var vec__53207 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53207,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53207,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__53242 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__53242) : instaparse.cfg.content.call(null,G__53242));
...
break;
case "paren":
var G__53418 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__53418;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__53269 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__53269) : instaparse.cfg.build_rule.call(null,G__53269));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__53271 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__53271) : instaparse.cfg.build_rule.call(null,G__53271));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__53272 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__53272) : instaparse.cfg.build_rule.call(null,G__53272));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__53273 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__53273) : instaparse.cfg.build_rule.call(null,G__53273));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__53274 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__53274) : instaparse.cfg.build_rule.call(null,G__53274));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__53275 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__53275) : instaparse.cfg.build_rule.call(null,G__53275));
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__53198__$1)].join('')));
...
while(true){
var G__53277 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "neg":
case "rep":
var G__53429 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__53429;
continue;
...
var valid_nts_53430 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__53284_53431 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__53285_53432 = null;
var count__53286_53433 = (0);
var i__53287_53434 = (0);
while(true){
if((i__53287_53434 < count__53286_53433)){
var nt_53435 = chunk__53285_53432.cljs$core$IIndexed$_nth$arity$2(null,i__53287_53434);
if(cljs.core.truth_((valid_nts_53430.cljs$core$IFn$_invoke$arity$1 ? valid_nts_53430.cljs$core$IFn$_invoke$arity$1(nt_53435) : valid_nts_53430.call(null,nt_53435)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_53435),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__53438 = seq__53284_53431;
var G__53439 = chunk__53285_53432;
var G__53440 = count__53286_53433;
var G__53441 = (i__53287_53434 + (1));
seq__53284_53431 = G__53438;
chunk__53285_53432 = G__53439;
count__53286_53433 = G__53440;
i__53287_53434 = G__53441;
continue;
} else {
var temp__5753__auto___53442 = cljs.core.seq(seq__53284_53431);
if(temp__5753__auto___53442){
var seq__53284_53443__$1 = temp__5753__auto___53442;
if(cljs.core.chunked_seq_QMARK_(seq__53284_53443__$1)){
var c__4679__auto___53444 = cljs.core.chunk_first(seq__53284_53443__$1);
var G__53445 = cljs.core.chunk_rest(seq__53284_53443__$1);
var G__53446 = c__4679__auto___53444;
var G__53447 = cljs.core.count(c__4679__auto___53444);
var G__53448 = (0);
seq__53284_53431 = G__53445;
chunk__53285_53432 = G__53446;
count__53286_53433 = G__53447;
i__53287_53434 = G__53448;
continue;
} else {
var nt_53450 = cljs.core.first(seq__53284_53443__$1);
if(cljs.core.truth_((valid_nts_53430.cljs$core$IFn$_invoke$arity$1 ? valid_nts_53430.cljs$core$IFn$_invoke$arity$1(nt_53450) : valid_nts_53430.call(null,nt_53450)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_53450),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__53451 = cljs.core.next(seq__53284_53443__$1);
var G__53452 = null;
var G__53453 = (0);
var G__53454 = (0);
seq__53284_53431 = G__53451;
chunk__53285_53432 = G__53452;
count__53286_53433 = G__53453;
i__53287_53434 = G__53454;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__53292_53455 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__53293_53456 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__53294_53457 = true;
var _STAR_print_fn_STAR__temp_val__53295_53458 = (function (x__4796__auto__){
return sb__4795__auto__.append(x__4796__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__53294_53457);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__53295_53458);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__53293_53456);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__53292_53455);
}
...
var len__4864__auto___53461 = arguments.length;
var i__4865__auto___53462 = (0);
while(true){
if((i__4865__auto___53462 < len__4864__auto___53461)){
args__4870__auto__.push((arguments[i__4865__auto___53462]));

var G__53463 = (i__4865__auto___53462 + (1));
i__4865__auto___53462 = G__53463;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__53323){
var map__53327 = p__53323;
var map__53327__$1 = cljs.core.__destructure_map(map__53327);
var opts = map__53327__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__53328 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__53329 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__53329);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4795__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__53331_53464 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__53332_53465 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__53333_53466 = true;
var _STAR_print_fn_STAR__temp_val__53334_53467 = (function (x__4796__auto__){
return sb__4795__auto__.append(x__4796__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__53333_53466);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__53334_53467);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__53332_53465);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__53331_53464);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4795__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__53328);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq53315){
