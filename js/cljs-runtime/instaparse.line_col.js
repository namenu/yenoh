...
(instaparse.line_col.Cursor.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k53041,else__4505__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k53041,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__53066){
var vec__53067 = p__53066;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53067,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53067,(1),null);
...
(instaparse.line_col.Cursor.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__53040){
var self__ = this;
var G__53040__$1 = this;
return (new cljs.core.RecordIter((0),G__53040__$1,3,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"index","index",-1531685915),new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"column","column",2078222095)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(instaparse.line_col.Cursor.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this53042,other53043){
var self__ = this;
var this53042__$1 = this;
return (((!((other53043 == null)))) && ((((this53042__$1.constructor === other53043.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this53042__$1.index,other53043.index)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this53042__$1.line,other53043.line)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this53042__$1.column,other53043.column)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this53042__$1.__extmap,other53043.__extmap)))))))))));
}));
...
(instaparse.line_col.Cursor.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k53041){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k53041);

}
}));

(instaparse.line_col.Cursor.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__53040){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__53076 = cljs.core.keyword_identical_QMARK_;
var expr__53077 = k__4511__auto__;
if(cljs.core.truth_((pred__53076.cljs$core$IFn$_invoke$arity$2 ? pred__53076.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"index","index",-1531685915),expr__53077) : pred__53076.call(null,new cljs.core.Keyword(null,"index","index",-1531685915),expr__53077)))){
return (new instaparse.line_col.Cursor(G__53040,self__.line,self__.column,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__53076.cljs$core$IFn$_invoke$arity$2 ? pred__53076.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"line","line",212345235),expr__53077) : pred__53076.call(null,new cljs.core.Keyword(null,"line","line",212345235),expr__53077)))){
return (new instaparse.line_col.Cursor(self__.index,G__53040,self__.column,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__53076.cljs$core$IFn$_invoke$arity$2 ? pred__53076.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"column","column",2078222095),expr__53077) : pred__53076.call(null,new cljs.core.Keyword(null,"column","column",2078222095),expr__53077)))){
return (new instaparse.line_col.Cursor(self__.index,self__.line,G__53040,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.line_col.Cursor(self__.index,self__.line,self__.column,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__53040),null));
}
}
}
}));
...
(instaparse.line_col.Cursor.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__53040){
var self__ = this;
var this__4501__auto____$1 = this;
return (new instaparse.line_col.Cursor(self__.index,self__.line,self__.column,G__53040,self__.__extmap,self__.__hash));
}));
 ...
 */
instaparse.line_col.map__GT_Cursor = (function instaparse$line_col$map__GT_Cursor(G__53044){
var extmap__4542__auto__ = (function (){var G__53084 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__53044,new cljs.core.Keyword(null,"index","index",-1531685915),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"column","column",2078222095)], 0));
if(cljs.core.record_QMARK_(G__53044)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__53084);
} else {
return G__53084;
}
})();
return (new instaparse.line_col.Cursor(new cljs.core.Keyword(null,"index","index",-1531685915).cljs$core$IFn$_invoke$arity$1(G__53044),new cljs.core.Keyword(null,"line","line",212345235).cljs$core$IFn$_invoke$arity$1(G__53044),new cljs.core.Keyword(null,"column","column",2078222095).cljs$core$IFn$_invoke$arity$1(G__53044),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
...
var G__53347 = (index + (1));
var G__53348 = line;
var G__53349 = (column + (1));
index = G__53347;
line = G__53348;
column = G__53349;
continue;
