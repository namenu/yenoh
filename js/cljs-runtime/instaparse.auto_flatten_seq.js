...
var instaparse$auto_flatten_seq$ConjFlat$conj_flat$dyn_50821 = (function (self,obj){
...
return instaparse$auto_flatten_seq$ConjFlat$conj_flat$dyn_50821(self,obj);
}
});

var instaparse$auto_flatten_seq$ConjFlat$cached_QMARK_$dyn_50822 = (function (self){
var x__4550__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$ConjFlat$cached_QMARK_$dyn_50822(self);
}
});
...
var G__50823 = n__$1;
var G__50824 = y;
var G__50825 = cljs.core.imul(z,z);
n = G__50823;
y = G__50824;
z = G__50825;
continue;
...
var G__50827 = n__$1;
var G__50828 = cljs.core.imul(z,y);
var G__50829 = cljs.core.imul(z,z);
n = G__50827;
y = G__50828;
z = G__50829;
continue;
...
var G__50831 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(v__$1,(0));
var G__50832 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(index__$1,(0));
v__$1 = G__50831;
index__$1 = G__50832;
continue;
} else {
...
if((cljs.core.peek(index) < ((function (){var G__50673 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__50673) : instaparse.auto_flatten_seq.true_count.call(null,G__50673));
})() - (1)))){
...
var G__50833 = v;
var G__50834 = cljs.core.pop(index);
v = G__50833;
index = G__50834;
continue;
...
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,index),(function (){var temp__5753__auto__ = instaparse.auto_flatten_seq.advance(v,index);
if(cljs.core.truth_(temp__5753__auto__)){
var next_index = temp__5753__auto__;
...
while(true){
if((!((coll__$1 == null)))){
var G__50861 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__50862 = cljs.core.next(coll__$1);
unmixed_hash = G__50861;
coll__$1 = G__50862;
continue;
} else {
return unmixed_hash;
...
while(true){
var temp__5751__auto__ = cljs.core.seq(v);
if(temp__5751__auto__){
var s = temp__5751__auto__;
var fst = cljs.core.first(v);
if(instaparse.auto_flatten_seq.afs_QMARK_(fst)){
var G__50864 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__50865 = cljs.core.next(v);
acc = G__50864;
v = G__50865;
continue;
} else {
var G__50866 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__50867 = cljs.core.next(v);
acc = G__50866;
v = G__50867;
continue;
}
...
var instaparse$auto_flatten_seq$GetVec$get_vec$dyn_50868 = (function (self){
var x__4550__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$GetVec$get_vec$dyn_50868(self);
}
});
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.call = (function (unused__10792__auto__){
var self__ = this;
var self__ = this;
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args50786){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args50786)));
}));
