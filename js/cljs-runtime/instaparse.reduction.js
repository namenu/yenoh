...
var G__51085 = new cljs.core.Keyword(null,"reduction-type","reduction-type",-488293450).cljs$core$IFn$_invoke$arity$1(f);
var G__51085__$1 = (((G__51085 instanceof cljs.core.Keyword))?G__51085.fqn:null);
switch (G__51085__$1) {
case "raw":
...
var temp__5751__auto__ = (instaparse.reduction.reduction_types.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.reduction_types.cljs$core$IFn$_invoke$arity$1(reduction_type) : instaparse.reduction.reduction_types.call(null,reduction_type));
if(cljs.core.truth_(temp__5751__auto__)){
var reduction = temp__5751__auto__;
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4652__auto__ = (function instaparse$reduction$iter__51102(s__51103){
return (new cljs.core.LazySeq(null,(function (){
var s__51103__$1 = s__51103;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__51103__$1);
if(temp__5753__auto__){
var s__51103__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__51103__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__51103__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__51105 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__51104 = (0);
while(true){
if((i__51104 < size__4651__auto__)){
var vec__51113 = cljs.core._nth(c__4650__auto__,i__51104);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51113,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51113,(1),null);
cljs.core.chunk_append(b__51105,(cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)));

var G__51217 = (i__51104 + (1));
i__51104 = G__51217;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__51105),instaparse$reduction$iter__51102(cljs.core.chunk_rest(s__51103__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__51105),null);
}
} else {
var vec__51141 = cljs.core.first(s__51103__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51141,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51141,(1),null);
return cljs.core.cons((cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)),instaparse$reduction$iter__51102(cljs.core.rest(s__51103__$2)));
}
} else {
return null;
}
