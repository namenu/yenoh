...
var G__50749 = (parser.cljs$core$IFn$_invoke$arity$1 ? parser.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"tag","tag",-1290361223)) : parser.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223)));
return (tag_set.cljs$core$IFn$_invoke$arity$1 ? tag_set.cljs$core$IFn$_invoke$arity$1(G__50749) : tag_set.call(null,G__50749));
} else {
...
instaparse.print.char_range__GT_str = (function instaparse$print$char_range__GT_str(p__50752){
var map__50753 = p__50752;
var map__50753__$1 = cljs.core.__destructure_map(map__50753);
var lo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50753__$1,new cljs.core.Keyword(null,"lo","lo",-931799889));
var hi = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50753__$1,new cljs.core.Keyword(null,"hi","hi",-1821422114));
...
(instaparse.print.combinators__GT_str.cljs$core$IFn$_invoke$arity$2 = (function (p__50783,hidden_QMARK_){
var map__50784 = p__50783;
var map__50784__$1 = cljs.core.__destructure_map(map__50784);
var p = map__50784__$1;
var parser = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50784__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310));
var parser1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50784__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422));
var parser2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50784__$1,new cljs.core.Keyword(null,"parser2","parser2",1013754688));
var parsers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50784__$1,new cljs.core.Keyword(null,"parsers","parsers",-804353827));
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50784__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
if(cljs.core.truth_((function (){var and__4251__auto__ = cljs.core.not(hidden_QMARK_);
if(and__4251__auto__){
...
var _STAR_print_newline_STAR__orig_val__50810_50872 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__50811_50873 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__50812_50874 = true;
var _STAR_print_fn_STAR__temp_val__50813_50875 = (function (x__4796__auto__){
return sb__4795__auto__.append(x__4796__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__50812_50874);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__50813_50875);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__50811_50873);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__50810_50872);
}
...
case "string-ci":
var sb__4795__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__50814_50876 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__50815_50877 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__50816_50878 = true;
var _STAR_print_fn_STAR__temp_val__50817_50879 = (function (x__4796__auto__){
return sb__4795__auto__.append(x__4796__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__50816_50878);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__50817_50879);

try{cljs.core.pr.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string","string",-1989541586).cljs$core$IFn$_invoke$arity$1(p)], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__50815_50877);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__50814_50876);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4795__auto__);
 ...
 */
instaparse.print.Parser__GT_str = (function instaparse$print$Parser__GT_str(p__50826){
var map__50830 = p__50826;
var map__50830__$1 = cljs.core.__destructure_map(map__50830);
var grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50830__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50830__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.cons(instaparse.print.rule__GT_str(start,(grammar.cljs$core$IFn$_invoke$arity$1 ? grammar.cljs$core$IFn$_invoke$arity$1(start) : grammar.call(null,start))),(function (){var iter__4652__auto__ = (function instaparse$print$Parser__GT_str_$_iter__50836(s__50837){
return (new cljs.core.LazySeq(null,(function (){
var s__50837__$1 = s__50837;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__50837__$1);
if(temp__5753__auto__){
var s__50837__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__50837__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__50837__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__50839 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__50838 = (0);
while(true){
if((i__50838 < size__4651__auto__)){
var vec__50840 = cljs.core._nth(c__4650__auto__,i__50838);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50840,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50840,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
cljs.core.chunk_append(b__50839,instaparse.print.rule__GT_str(non_terminal,parser));

var G__50893 = (i__50838 + (1));
i__50838 = G__50893;
continue;
} else {
var G__50894 = (i__50838 + (1));
i__50838 = G__50894;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__50839),instaparse$print$Parser__GT_str_$_iter__50836(cljs.core.chunk_rest(s__50837__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__50839),null);
}
} else {
var vec__50843 = cljs.core.first(s__50837__$2);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50843,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50843,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
return cljs.core.cons(instaparse.print.rule__GT_str(non_terminal,parser),instaparse$print$Parser__GT_str_$_iter__50836(cljs.core.rest(s__50837__$2)));
} else {
var G__50895 = cljs.core.rest(s__50837__$2);
s__50837__$1 = G__50895;
continue;
}
}
} else {
