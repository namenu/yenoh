...
var i_43998 = (0);
while(true){
if((i_43998 < arr.length)){
(arr[i_43998] = null);

var G__43999 = (i_43998 + (1));
i_43998 = G__43999;
continue;
} else {
}
...
var i_44006 = (self__.level + (1));
while(true){
if((i_44006 <= (new_level + (1)))){
(update[i_44006] = self__.header);

var G__44008 = (i_44006 + (1));
i_44006 = G__44008;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_44009 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_44009[i]));
} else {
x__$2.forward.push((((i < links_44009.length))?(links_44009[i]):null));
}

if((i < links_44009.length)){
(links_44009[i] = x__$2);
} else {
links_44009.push(x__$2);
}
...
var i_44014 = (0);
while(true){
if((i_44014 <= self__.level)){
var links_44015 = (update[i_44014]).forward;
if((x__$1 === (((i_44014 < links_44015.length))?(links_44015[i_44014]):null))){
(links_44015[i_44014] = (x__$1.forward[i_44014]));

var G__44016 = (i_44014 + (1));
i_44014 = G__44016;
continue;
} else {
var G__44017 = (i_44014 + (1));
i_44014 = G__44017;
continue;
}
} else {
...
var G__44022 = nx;
var G__44023 = (level__$1 - (1));
x = G__44022;
level__$1 = G__44023;
continue;
} else {
var G__44025 = x;
var G__44026 = (level__$1 - (1));
x = G__44025;
level__$1 = G__44026;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__44028 = nx;
var G__44029 = (level__$1 - (1));
x = G__44028;
level__$1 = G__44029;
continue;
} else {
var G__44030 = x;
var G__44031 = (level__$1 - (1));
x = G__44030;
level__$1 = G__44031;
continue;
}
