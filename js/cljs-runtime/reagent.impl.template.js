...
var G__50751 = o;
reagent.impl.template.goog$module$goog$object.set(G__50751,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__51014__delegate = function (args){
...
return G__51014__delegate.call(this,args);};
G__51014.cljs$lang$maxFixedArity = 0;
G__51014.cljs$lang$applyTo = (function (arglist__51016){
var args = cljs.core.seq(arglist__51016);
return G__51014__delegate(args);
});
...
var G__50785 = o;
reagent.impl.template.goog$module$goog$object.set(G__50785,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__51019__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__51019 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__51020__i = 0, G__51020__a = new Array(arguments.length -  0);
while (G__51020__i < G__51020__a.length) {G__51020__a[G__51020__i] = arguments[G__51020__i + 0]; ++G__51020__i;}
  args = new cljs.core.IndexedSeq(G__51020__a,0,null);
} 
return G__51019__delegate.call(this,args);};
G__51019.cljs$lang$maxFixedArity = 0;
G__51019.cljs$lang$applyTo = (function (arglist__51021){
var args = cljs.core.seq(arglist__51021);
return G__51019__delegate(args);
});
G__51019.cljs$core$IFn$_invoke$arity$variadic = G__51019__delegate;
return G__51019;
})()
;
} else {
...
var G__50794 = props;
var G__50794__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50794,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__50794);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50794__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__50806 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50806,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__50806;
}
})(),id_class);
...
var G__50807 = (cljs.core.count(argv) - first_child);
switch (G__50807) {
case (0):
...
var vec__50818 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50818,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50818,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50818,(2),null);
...
var temp__5757__auto___51027 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___51027 == null)){
} else {
var key_51028 = temp__5757__auto___51027;
(jsprops.key = key_51028);
}
...
var temp__5757__auto___51029 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___51029 == null)){
} else {
var key_51030 = temp__5757__auto___51029;
(jsprops.key = key_51030);
}
...
var temp__5757__auto___51031 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___51031 == null)){
} else {
var key_51032 = temp__5757__auto___51031;
(jsprops.key = key_51032);
}
...
var temp__5757__auto___51041 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___51041 == null)){
} else {
var key_51044 = temp__5757__auto___51041;
(jsprops.key = key_51044);
}
...
var temp__5757__auto___51045 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___51045 == null)){
} else {
var key_51046 = temp__5757__auto___51045;
(jsprops.key = key_51046);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50846_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__50846_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__50869 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50869,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50869,(1),null);
...
break;
default:
var G__51057 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__51058 = compiler;
v = G__51057;
compiler = G__51058;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template50940 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template50940 = (function (opts,id,fn_to_element,parse_fn,meta50941){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template50940.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_50942,meta50941__$1){
var self__ = this;
var _50942__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template50940(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta50941__$1));
}));

(reagent.impl.template.t_reagent$impl$template50940.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_50942){
var self__ = this;
var _50942__$1 = this;
return self__.meta50941;
}));

(reagent.impl.template.t_reagent$impl$template50940.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template50940.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template50940.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template50940.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template50940.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template50940.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta50941","meta50941",286103752,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template50940.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template50940.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template50940");

(reagent.impl.template.t_reagent$impl$template50940.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template50940");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template50940.
 */
reagent.impl.template.__GT_t_reagent$impl$template50940 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template50940(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta50941){
return (new reagent.impl.template.t_reagent$impl$template50940(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta50941));
});

}

return (new reagent.impl.template.t_reagent$impl$template50940(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
