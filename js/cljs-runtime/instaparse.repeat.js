...
var vec__53027 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53027,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53027,(1),null);
...
var vec__53033 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53033,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53033,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__53037 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53037,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53037,(1),null);
...
var temp__5751__auto__ = cljs.core.seq(instaparse.repeat.parse_from_index(grammar,initial_parser,text,segment,end__$1));
if(temp__5751__auto__){
var follow_ups = temp__5751__auto__;
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [parse,end__$1,follow_ups], null);
} else {
var G__53350 = cljs.core.next(parses__$1);
parses__$1 = G__53350;
continue;
}
...
var G__53054 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__53055 = G__53054;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53055,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53055,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53055,(2),null);
var selection = vec__53055;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__53054__$1 = G__53054;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__53063 = G__53054__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53063,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53063,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53063,(2),null);
var selection__$1 = vec__53063;
...
var G__53352 = cljs.core.long$(end__$1);
var G__53353 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__53354 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__53352;
parses__$1 = G__53353;
G__53054__$1 = G__53354;
continue;
...
var G__53099 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__53100 = G__53099;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53100,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53100,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53100,(2),null);
var selection = vec__53100;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__53099__$1 = G__53099;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__53109 = G__53099__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53109,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53109,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53109,(2),null);
var selection__$1 = vec__53109;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__53405 = cljs.core.long$(end__$1);
var G__53406 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__53407 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__53405;
parses__$1 = G__53406;
G__53099__$1 = G__53407;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__53128 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__53129 = G__53128;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53129,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53129,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53129,(2),null);
var selection = vec__53129;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__53128__$1 = G__53128;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__53139 = G__53128__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53139,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53139,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53139,(2),null);
var selection__$1 = vec__53139;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__53420 = cljs.core.long$(end__$1);
var G__53421 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__53422 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__53420;
parses__$1 = G__53421;
G__53128__$1 = G__53422;
continue;
...
if(cljs.core.truth_((function (){var fexpr__53288 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__53288.cljs$core$IFn$_invoke$arity$1 ? fexpr__53288.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__53288.call(null,output_format));
})())){
} else {
...
var and__4251__auto____$1 = (function (){var G__53301 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__53300 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
