...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_40966 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_40966(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_40968 = (function (port,val,fn1_handler){
var x__4550__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_40968(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_40972 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_40972(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_40977 = (function (chan){
var x__4550__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_40977(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_40979 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_40979(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_40983 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_40983(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_40987 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_40987(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_40988 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_40988(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_40990 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_40990(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_40991 = (function (b,itm){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_40991(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_40992 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_40992(b);
}
});
